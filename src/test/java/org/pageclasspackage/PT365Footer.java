...
// the page elements and their functions corresponds to PT365 in the footer of the home page
// when we click PT365 , it redirects to respective page PT365

public class PT365Footer extends VisionBaseClass {

	WebDriver driver;
	public PT365Footer(WebDriver driver) {
		this.driver=driver;
		PageFactory.initElements(driver, this);
	}

	// PT365 in footer of home page

	@FindBy(xpath = "(//*[@class='accordion-body'])[1]/ul/li[7]/a/span")
	private WebElement footerPt365;
	...
	private List<WebElement> buyCourseInPT365;
	...
	// click PT365 in footer of HomePage

	public void clickPT365InFooter() {
		...
		jk.executeScript("arguments[0].click();", footerPt365);

	}

	// click buy course in PT365 Page

	public void clickBuyCourseInPT365() {
		...
		if (buyCourseInPT365.size() > 0) {

			// create instance for Random class

			Random random = new Random();

			int randomIndex = random.nextInt(buyCourseInPT365.size());

			// click randomly selected element

			WebElement buyCourse = buyCourseInPT365.get(randomIndex);
	...
	public void verifyAboutTheProgramAndWhyChooseOurProgram() {
	...
	public void verifyDownloadAndShare() {

		// share

		shareButton.click();

		extentTest.info("Share functionality  of PT365 page verified");
		...
		extentTest.info("Download brochure of PT365 page verified");
