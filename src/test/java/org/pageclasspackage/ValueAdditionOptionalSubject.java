...
public class ValueAdditionOptionalSubject extends VisionBaseClass {

	WebDriver driver;

	public ValueAdditionOptionalSubject(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div[2]/div[2]/div[2]/a[12]/div/div")
	private WebElement ValueAdditionOptionalSubject;

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div/div/div/main")
	private WebElement ValueAdditionOptionalSubjectBannerText;
	...
	private WebElement likeButtonOnValueAdditionOptionalSubject;

	@FindBy(xpath = "(//i[contains(@class,'icon-thumbs-up pr-1')])[2]")
	private WebElement likeButtonStatus;

	@FindBy(xpath = "(//*[@class='Home_main__OVLM4']/div[1]/div[2]/div[2]/div[2]/div/div/div/div/div/div[2]/div/div[2])[2]")
	private WebElement downloadButtonOnValueAdditionOptionalSubject;

	// Download the document on ValueAdditionOptionalSubject For Random option
	...
	public boolean isLikeButtonClickable() {
		try {
			return likeButtonOnValueAdditionOptionalSubject.isEnabled()
					&& likeButtonOnValueAdditionOptionalSubject.isDisplayed();
	...
	// This is used to click ValueAdditionOptionalSubject in Current Affairs
	public ValueAdditionOptionalSubject clickValueAdditionOptionalSubject() throws InterruptedException {
		// Wait for a maximum of 10 seconds for the banner text to be displayed
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(ValueAdditionOptionalSubject));

		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,700)", "");

		ValueAdditionOptionalSubject.click();

		return this;
	}

	// Display the Banner Text of ValueAdditionOptionalSubject
	public boolean displayBannerTextOfValueAdditionOptionalSubject() {
		// Wait for a maximum of 10 seconds for the banner text to be displayed
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOf(ValueAdditionOptionalSubjectBannerText));

		String text = ValueAdditionOptionalSubjectBannerText.getText();
		extentTest.info(text);

		return ValueAdditionOptionalSubjectBannerText.isDisplayed();
	}

	// This is used to click the Download button at ValueAdditionOptionalSubject
	public boolean clickDownloadRandomlyOnValueAdditionOptionalSubject() {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		...
		// Wait for a maximum of 10 seconds for the selected download button to be
		// clickable
	...
	// This is used to get the Title of Document at ValueAdditionOptionalSubject
	public boolean getTitleOfDocumentInValueAdditionOptionalSubject() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,400)");
	...
	// This is used to get the year of the Document at ValueAdditionOptionalSubject
	public boolean displayYearOnDocumentInValueAdditionOptionalSubject() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
	...
	// This is used to get the Medium of the Document at
	// ValueAdditionOptionalSubject
	public boolean displayMediumOnDocumentInValueAdditionOptionalSubject() throws InterruptedException {
	...
	// This is used to click the Like Button in ValueAdditionOptionalSubject
	// documents
	public boolean displayAndLikeTheDocumentInValueAdditionOptionalSubject() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,500)", "");
	...
	public String getBeforeLikeCount() {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(likeButtonOnValueAdditionOptionalSubject));
		return likeButtonOnValueAdditionOptionalSubject.getText();
	}
	...
	// This is used to click the Like button at ValueAdditionOptionalSubject
	public ValueAdditionOptionalSubject clickLikeOnValueAdditionOptionalSubject() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,400)", "");
		// Use WebDriverWait for waiting until the element is clickable
		try {
			likeButtonOnValueAdditionOptionalSubject.click();
	...
	// and again click the Like button in ValueAdditionOptionalSubject
	public boolean displayLikeCountOfTheDocumentAfterRefreshInValueAdditionOptionalSubject()
	...
	public String getBeforeDownloadCount() {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnValueAdditionOptionalSubject));
		return downloadButtonOnValueAdditionOptionalSubject.getText();
	}
	...
	// This is used to click the Like button at ValueAdditionOptionalSubject
	public ValueAdditionOptionalSubject clickDownloadValueAdditionOptionalSubject() throws InterruptedException {
		synchronized (driver) {
			driver.wait(2000);
		}
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnValueAdditionOptionalSubject));
		downloadButtonOnValueAdditionOptionalSubject.click();
		return this;
	}

	// This is used to count the document Download before user login and refresh the
	// same page and again click the Like button in ValueAdditionOptionalSubject
	public boolean displayDownloadCountOfTheDocumentAfterRefreshInValueAdditionOptionalSubject()
			throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,500)", "");
	...
	// This is used to click the Share button at Value Addition Optional Subject
	public ValueAdditionOptionalSubject clickShareValueAdditionOptionalSubject() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,400)", "");
	...
	public ValueAdditionOptionalSubject copyThePageLink() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	// This is used to click on Whatsapp in Share with window
	public ValueAdditionOptionalSubject clickWhatsapp() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public ValueAdditionOptionalSubject clickFacebook() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public ValueAdditionOptionalSubject clickGmail() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	// This is used to click on gmail in Share with window
	public ValueAdditionOptionalSubject clickTelegram() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public ValueAdditionOptionalSubject clickCloseButtonInSharePopup() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public ValueAdditionOptionalSubject clickRandomPage() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,400)", "");
	...
	public ValueAdditionOptionalSubject clickClearFilter() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public ValueAdditionOptionalSubject clickFilter() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public ValueAdditionOptionalSubject clickSelectYear() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public ValueAdditionOptionalSubject clickApplyFilter() throws InterruptedException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public ValueAdditionOptionalSubject clickSectionsFilter() throws InterruptedException, AWTException {
		// Use WebDriverWait for waiting until the element is clickable
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
