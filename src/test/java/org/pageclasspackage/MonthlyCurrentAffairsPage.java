...
public class MonthlyCurrentAffairsPage extends VisionBaseClass {
	...
	WebDriver driver;
	public MonthlyCurrentAffairsPage(WebDriver driver) {
		this.driver=driver;
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div[2]/div[2]/div[2]/a[4]/div/div")
	private WebElement monthlyCurrentAffairsPage;

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div/div/div/main")
	private WebElement monthlyCurrentAffairsPageBannerText;
	...
	private WebElement likeButtonOnMonthlyCurrentAffairsPage;
	
	@FindBy(xpath = "(//*[@class='Home_main__OVLM4']/div[1]/div[2]/div[2]/div[2]/div/div/div/div/div/div[2]/div/div[2])[2]")
	private WebElement downloadButtonOnMonthlyCurrentAffairsPage;
	
	//Download the document on MonthlyCurrentAffairsPage For Random option
	...
	public boolean isLikeButtonClickable() {
	    try {
	        return likeButtonOnMonthlyCurrentAffairsPage.isEnabled() && likeButtonOnMonthlyCurrentAffairsPage.isDisplayed();
	...
	// This is used to click MonthlyCurrentAffairsPage in Current Affairs
		public MonthlyCurrentAffairsPage clickMonthlyCurrentAffairsPage() throws InterruptedException {
			  // Wait for a maximum of 10 seconds for the banner text to be displayed
		    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		    wait.until(ExpectedConditions.elementToBeClickable(monthlyCurrentAffairsPage));

			JavascriptExecutor jk = (JavascriptExecutor) driver;
			jk.executeScript("window.scrollBy(0,400)", "");
			
			monthlyCurrentAffairsPage.click();
			
			return this;
		}

		// Display the Banner Text of MonthlyCurrentAffairsPage
				public boolean displayBannerTextOfMonthlyCurrentAffairsPage() {
				    // Wait for a maximum of 10 seconds for the banner text to be displayed
				    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
				    wait.until(ExpectedConditions.visibilityOf(monthlyCurrentAffairsPageBannerText));

				    String text = monthlyCurrentAffairsPageBannerText.getText();
				    extentTest.info(text);

				    return monthlyCurrentAffairsPageBannerText.isDisplayed();
				}
				
				// This is used to click the Download button at MonthlyCurrentAffairsPage
					public boolean clickDownloadRandomlyOnMonthlyCurrentAffairsPage() {
					    JavascriptExecutor jk = (JavascriptExecutor) driver;
					    jk.executeScript("window.scrollBy(0,400)");
					...
					// This is used to get the Title of Document at  MonthlyCurrentAffairsPage
					public boolean getTitleOfDocumentInMonthlyCurrentAffairsPage() throws InterruptedException {
					    JavascriptExecutor jk = (JavascriptExecutor) driver;
					    jk.executeScript("window.scrollBy(0,400)");
					...
					// This is used to get the year of the Document at MonthlyCurrentAffairsPage
					public boolean displayYearOnDocumentInMonthlyCurrentAffairsPage() throws InterruptedException {
						JavascriptExecutor jk = (JavascriptExecutor) driver;
					...
					// This is used to get the Medium of the Document at  MonthlyCurrentAffairsPage
					public boolean displayMediumOnDocumentInMonthlyCurrentAffairsPage() throws InterruptedException {
					...
					// This is used to click the Like Button in MonthlyCurrentAffairsPage documents
					public boolean displayAndLikeTheDocumentInMonthlyCurrentAffairsPage() throws InterruptedException {
						JavascriptExecutor jk = (JavascriptExecutor) driver;
						jk.executeScript("window.scrollBy(0,500)", "");
					...
					public String getBeforeLikeCount() {
				        ...
				        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						wait.until(ExpectedConditions.elementToBeClickable(likeButtonOnMonthlyCurrentAffairsPage));
					    return likeButtonOnMonthlyCurrentAffairsPage.getText();
					}
					...
					// This is used to click the Like button at MonthlyCurrentAffairsPage
					public MonthlyCurrentAffairsPage clickLikeOnMonthlyCurrentAffairsPage() throws InterruptedException {
							JavascriptExecutor jk = (JavascriptExecutor) driver;
							jk.executeScript("window.scrollBy(0,400)", "");
							// Use WebDriverWait for waiting until the element is clickable
							 try {
								 likeButtonOnMonthlyCurrentAffairsPage.click();
					...
					// Check Like count of the document before user login and refresh the same page and again click the Like button in MonthlyCurrentAffairsPage
								public boolean displayLikeCountOfTheDocumentAfterRefreshInMonthlyCurrentAffairsPage() throws InterruptedException {
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,500)", "");
								...
								public String getBeforeDownloadCount() {
									 // Use WebDriverWait for waiting until the element is clickable
							        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
									wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnMonthlyCurrentAffairsPage));
								    return downloadButtonOnMonthlyCurrentAffairsPage.getText();
								}
								...
								// This is used to click the Like button at MonthlyCurrentAffairsPage
								public MonthlyCurrentAffairsPage clickDownloadMonthlyCurrentAffairsPage() throws InterruptedException {
								        ...
								        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
										wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnMonthlyCurrentAffairsPage));
										downloadButtonOnMonthlyCurrentAffairsPage.click();
										return this;
								}		
								
								// This is used to count the document Download before user login and refresh the same page and again click the Like button in MonthlyCurrentAffairs Page
								public boolean displayDownloadCountOfTheDocumentAfterRefreshInMonthlyCurrentAffairsPage() throws InterruptedException {
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,500)", "");
								...
								public MonthlyCurrentAffairsPage clickShareMonthlyCurrentAffairsPage() throws InterruptedException {
									synchronized (driver) {driver.wait(2000);}
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,400)", "");
							...
							public MonthlyCurrentAffairsPage copyThePageLink() throws InterruptedException {
								 // Use WebDriverWait for waiting until the element is clickable
							       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
							...
							// This is used to click on Whatsapp in Share  with window
							public MonthlyCurrentAffairsPage clickWhatsapp() throws InterruptedException {
								 // Use WebDriverWait for waiting until the element is clickable
							       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public MonthlyCurrentAffairsPage clickFacebook() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public MonthlyCurrentAffairsPage clickGmail() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						// This is used to click on gmail in Share  with window
						public MonthlyCurrentAffairsPage clickTelegram() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public MonthlyCurrentAffairsPage clickCloseButtonInSharePopup() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public MonthlyCurrentAffairsPage clickRandomPage() throws InterruptedException {
							JavascriptExecutor jk = (JavascriptExecutor) driver;
							jk.executeScript("window.scrollBy(0,400)", "");
						...
						public MonthlyCurrentAffairsPage clickClearFilter() throws InterruptedException {
							// Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public MonthlyCurrentAffairsPage clickFilter() throws InterruptedException {
							// Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public MonthlyCurrentAffairsPage clickSelectYear() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public MonthlyCurrentAffairsPage clickApplyFilter() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
