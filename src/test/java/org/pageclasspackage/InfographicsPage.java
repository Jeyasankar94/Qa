...
public class InfographicsPage extends VisionBaseClass {
	...
	@FindBy(xpath = "//label[text()='Infographics']")	
	private WebElement infographicsPage;

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div/div/div/main")
	private WebElement infographicsPageBannerText;
	...
	private WebElement likeButtonOnInfographicsPage;
	
	@FindBy(xpath = "(//*[@class='Home_main__OVLM4']/div[1]/div[2]/div[2]/div[2]/div/div/div/div/div/div[2]/div/div[2])[2]")
	private WebElement downloadButtonOnInfographicsPage;
	
	//Download the document on InfographicsPage For Random option
	...
	public boolean isLikeButtonClickable() {
	    try {
	        return likeButtonOnInfographicsPage.isEnabled() && likeButtonOnInfographicsPage.isDisplayed();
	...
	// This is used to click InfographicsPage in Current Affairs
		public InfographicsPage clickInfographicsPage() throws InterruptedException {
			  // Wait for a maximum of 10 seconds for the banner text to be displayed
		    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		    wait.until(ExpectedConditions.elementToBeClickable(infographicsPage));

			infographicsPage.click();
			
			return this;
		}

		// Display the Banner Text of InfographicsPage
				public boolean displayBannerTextOfInfographicsPage() {
				    // Wait for a maximum of 10 seconds for the banner text to be displayed
				    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
				    wait.until(ExpectedConditions.visibilityOf(infographicsPageBannerText));

				    String text = infographicsPageBannerText.getText();
				    extentTest.info(text);

				    return infographicsPageBannerText.isDisplayed();
				}
				
				// This is used to click the Download button at InfographicsPage
					public boolean clickDownloadRandomlyOnInfographicsPage() {
					...
					// This is used to get the Title of Document at  InfographicsPage
					public boolean getTitleOfDocumentInInfographicsPage() throws InterruptedException {
					    JavascriptExecutor jk = (JavascriptExecutor) driver;
					    jk.executeScript("window.scrollBy(0,400)");
					...
					// This is used to get the year of the Document at InfographicsPage
					public boolean displayYearOnDocumentInInfographicsPage() throws InterruptedException {
						JavascriptExecutor jk = (JavascriptExecutor) driver;
					...
					// This is used to get the Medium of the Document at  InfographicsPage
					public boolean displayMediumOnDocumentInInfographicsPage() throws InterruptedException {
					...
					// This is used to click the Like Button in InfographicsPage documents
					public boolean displayAndLikeTheDocumentInInfographicsPage() throws InterruptedException {
						JavascriptExecutor jk = (JavascriptExecutor) driver;
						jk.executeScript("window.scrollBy(0,500)", "");
					...
					public String getBeforeLikeCount() {
				        ...
				        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						wait.until(ExpectedConditions.elementToBeClickable(likeButtonOnInfographicsPage));
					    return likeButtonOnInfographicsPage.getText();
					}
					...
					// This is used to click the Like button at InfographicsPage
					public InfographicsPage clickLikeOnInfographicsPage() throws InterruptedException {
							JavascriptExecutor jk = (JavascriptExecutor) driver;
							jk.executeScript("window.scrollBy(0,400)", "");
							// Use WebDriverWait for waiting until the element is clickable
							 try {
							    	likeButtonOnInfographicsPage.click();
					...
					// Check Like count of the document before user login and refresh the same page and again click the Like button in InfographicsPage
								public boolean displayLikeCountOfTheDocumentAfterRefreshInInfographicsPage() throws InterruptedException {
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,500)", "");
								...
								public String getBeforeDownloadCount() {
									 // Use WebDriverWait for waiting until the element is clickable
							        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
									wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnInfographicsPage));
								    return downloadButtonOnInfographicsPage.getText();
								}
								...
								// This is used to click the Like button at InfographicsPage
								public InfographicsPage clickDownloadInfographicsPage() throws InterruptedException {
								        ...
								        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
										wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnInfographicsPage));
										downloadButtonOnInfographicsPage.click();
										return this;
								}		
								
								// This is used to count the document Download before user login and refresh the same page and again click the Like button in InfographicsPage
								public boolean displayDownloadCountOfTheDocumentAfterRefreshInInfographicsPage() throws InterruptedException {
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,500)", "");
								...
								public InfographicsPage clickShareInfographicsPage() throws InterruptedException {
									synchronized (driver) {driver.wait(2000);}
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,400)", "");
							...
							public InfographicsPage copyThePageLink() throws InterruptedException {
								 // Use WebDriverWait for waiting until the element is clickable
							       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
							...
							// This is used to click on Whatsapp in Share  with window
							public InfographicsPage clickWhatsapp() throws InterruptedException {
								 // Use WebDriverWait for waiting until the element is clickable
							       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public InfographicsPage clickFacebook() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public InfographicsPage clickGmail() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						// This is used to click on gmail in Share  with window
						public InfographicsPage clickTelegram() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public InfographicsPage clickCloseButtonInSharePopup() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public InfographicsPage clickRandomPage() throws InterruptedException {
							JavascriptExecutor jk = (JavascriptExecutor) driver;
							jk.executeScript("window.scrollBy(0,400)", "");
						...
						public InfographicsPage clickClearFilter() throws InterruptedException {
							// Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public InfographicsPage clickFilter() throws InterruptedException {
							// Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public InfographicsPage clickSelectYear() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public InfographicsPage clickSelectMedium() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public InfographicsPage clickApplyFilter() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public InfographicsPage clickSubjectsFilter() throws InterruptedException, AWTException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
			...
			//						extentTest.info("Selected Medium is :" +mediumFilter);
								...
								public InfographicsPage clickToppersFilter() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
