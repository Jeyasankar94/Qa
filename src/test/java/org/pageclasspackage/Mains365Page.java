...
public class Mains365Page extends VisionBaseClass {
	...
	WebDriver driver;
	public Mains365Page(WebDriver driver) {
		this.driver=driver;
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div[2]/div[2]/div[2]/a[7]/div/div")
	private WebElement Mains365Page;

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div/div/div/main")
	private WebElement Mains365PageBannerText;
	...
	private WebElement likeButtonOnMains365Page;
	
	@FindBy(xpath = "(//i[contains(@class,'icon-thumbs-up pr-1')])[2]")	      		//i[@class='icon-thumbs-up pr-1 text-[#686E70] dark:text-[#fff]']
	...
	private WebElement downloadButtonOnMains365Page;
	
	//Download the document on Mains365Page For Random option
	...
	public boolean isLikeButtonClickable() {
	    try {
	        return likeButtonOnMains365Page.isEnabled() && likeButtonOnMains365Page.isDisplayed();
	...
	// This is used to click Mains365Page in Current Affairs
		public Mains365Page clickMains365Page() throws InterruptedException {
			  // Wait for a maximum of 10 seconds for the banner text to be displayed
		    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		    wait.until(ExpectedConditions.elementToBeClickable(Mains365Page));
		...
		// Display the Banner Text of Mains365Page
				public boolean displayBannerTextOfMains365Page() {
				    // Wait for a maximum of 10 seconds for the banner text to be displayed
				    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
				    wait.until(ExpectedConditions.visibilityOf(Mains365PageBannerText));

				    String text = Mains365PageBannerText.getText();
				    extentTest.info(text);

				    return Mains365PageBannerText.isDisplayed();
				}
				
				// This is used to click the Download button at Mains365Page
					public boolean clickDownloadRandomlyOnMains365Page() {
					    JavascriptExecutor jk = (JavascriptExecutor) driver;
					    jk.executeScript("window.scrollBy(0,400)");
					...
					// This is used to get the Title of Document at  Mains365Page
					public boolean getTitleOfDocumentInMains365Page() throws InterruptedException {
					    JavascriptExecutor jk = (JavascriptExecutor) driver;
					    jk.executeScript("window.scrollBy(0,400)");
					...
					// This is used to get the year of the Document at Mains365Page
					public boolean displayYearOnDocumentInMains365Page() throws InterruptedException {
						JavascriptExecutor jk = (JavascriptExecutor) driver;
					...
					// This is used to get the Medium of the Document at  Mains365Page
					public boolean displayMediumOnDocumentInMains365Page() throws InterruptedException {
					...
					// This is used to click the Like Button in Mains365Page documents
					public boolean displayAndLikeTheDocumentInMains365Page() throws InterruptedException {
						JavascriptExecutor jk = (JavascriptExecutor) driver;
						jk.executeScript("window.scrollBy(0,500)", "");
					...
					public String getBeforeLikeCount() {
				        ...
				        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						wait.until(ExpectedConditions.elementToBeClickable(likeButtonOnMains365Page));
					    return likeButtonOnMains365Page.getText();
					}
					...
					// This is used to click the Like button at Mains365Page
					public Mains365Page clickLikeOnMains365Page() throws InterruptedException {
							JavascriptExecutor jk = (JavascriptExecutor) driver;
							jk.executeScript("window.scrollBy(0,400)", "");
							// Use WebDriverWait for waiting until the element is clickable
							 try {
							    	likeButtonOnMains365Page.click();
					...
					// Check Like count of the document before user login and refresh the same page and again click the Like button in Mains365Page
								public boolean displayLikeCountOfTheDocumentAfterRefreshInMains365Page() throws InterruptedException {
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,500)", "");
								...
								public String getBeforeDownloadCount() {
									 // Use WebDriverWait for waiting until the element is clickable
							        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
									wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnMains365Page));
								    return downloadButtonOnMains365Page.getText();
								}
								...
								// This is used to click the Like button at Mains365Page
								public Mains365Page clickDownloadMains365Page() throws InterruptedException {
								        ...
								        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
										wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnMains365Page));
										downloadButtonOnMains365Page.click();
										return this;
								}		
								
								// This is used to count the document Download before user login and refresh the same page and again click the Like button in Mains365Page
								public boolean displayDownloadCountOfTheDocumentAfterRefreshInMains365Page() throws InterruptedException {
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,500)", "");
								...
								public Mains365Page clickShareMains365Page() throws InterruptedException {
									synchronized (driver) {driver.wait(2000);}
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,400)", "");
							...
							public Mains365Page copyThePageLink() throws InterruptedException {
								 // Use WebDriverWait for waiting until the element is clickable
							       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
							...
							// This is used to click on Whatsapp in Share  with window
							public Mains365Page clickWhatsapp() throws InterruptedException {
								 // Use WebDriverWait for waiting until the element is clickable
							       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public Mains365Page clickFacebook() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public Mains365Page clickGmail() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						// This is used to click on gmail in Share  with window
						public Mains365Page clickTelegram() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public Mains365Page clickCloseButtonInSharePopup() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public Mains365Page clickRandomPage() throws InterruptedException {
							JavascriptExecutor jk = (JavascriptExecutor) driver;
							jk.executeScript("window.scrollBy(0,400)", "");
						...
						public Mains365Page clickClearFilter() throws InterruptedException {
							// Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public Mains365Page clickFilter() throws InterruptedException {
							// Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public Mains365Page clickSelectYear() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public Mains365Page clickApplyFilter() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public Mains365Page clickMediumFilter() throws InterruptedException, AWTException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
