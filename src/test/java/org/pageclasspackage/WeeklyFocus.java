...
public class WeeklyFocus extends VisionBaseClass {

	WebDriver driver;
	public WeeklyFocus(WebDriver driver) {
		this.driver=driver;
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div[2]/div[2]/div[2]/a[3]/div/div")
	private WebElement weeklyFocus;

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div/div/div/main")
	private WebElement weeklyFocusBannerText;
	...
	private WebElement likeButtonOnWeeklyFocus;
	
	@FindBy(xpath = "(//*[@class='Home_main__OVLM4']/div[1]/div[2]/div[2]/div[2]/div/div/div/div/div/div[2]/div/div[2])[2]")
	private WebElement downloadButtonOnWeeklyFocus;
	
	//Download the document on WeeklyFocus For Random option
	...
	public boolean isLikeButtonClickable() {
	    try {
	        return likeButtonOnWeeklyFocus.isEnabled() && likeButtonOnWeeklyFocus.isDisplayed();
	...
	// This is used to click WeeklyFocus in Current Affairs
		public WeeklyFocus clickWeeklyFocus() throws InterruptedException {
			  // Wait for a maximum of 10 seconds for the banner text to be displayed
		   WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		    wait.until(ExpectedConditions.elementToBeClickable(weeklyFocus));
		...
		// Display the Banner Text of WeeklyFocus
				public boolean displayBannerTextOfWeeklyFocus() {
				    // Wait for a maximum of 10 seconds for the banner text to be displayed
				   WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
				    wait.until(ExpectedConditions.visibilityOf(weeklyFocusBannerText));

				    String text = weeklyFocusBannerText.getText();
				    extentTest.info(text);

				    return weeklyFocusBannerText.isDisplayed();
				}
				
				// This is used to click the Download button at WeeklyFocus
					public boolean clickDownloadRandomlyOnWeeklyFocus() {
					    JavascriptExecutor jk = (JavascriptExecutor) driver;
					...
					// This is used to get the Title of Document at  WeeklyFocus
					public boolean getTitleOfDocumentInWeeklyFocus() throws InterruptedException {
					    JavascriptExecutor jk = (JavascriptExecutor) driver;
					    jk.executeScript("window.scrollBy(0,400)");
					...
					// This is used to get the year of the Document at WeeklyFocus
					public boolean displayYearOnDocumentInWeeklyFocus() throws InterruptedException {
						JavascriptExecutor jk = (JavascriptExecutor) driver;
					...
					// This is used to get the Medium of the Document at  WeeklyFocus
					public boolean displayMediumOnDocumentInWeeklyFocus() throws InterruptedException {
					...
					// This is used to click the Like Button in WeeklyFocus documents
					public boolean displayAndLikeTheDocumentInWeeklyFocus() throws InterruptedException {
						JavascriptExecutor jk = (JavascriptExecutor) driver;
						jk.executeScript("window.scrollBy(0,500)", "");
					...
					public String getBeforeLikeCount() {
				        ...
				        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						wait.until(ExpectedConditions.elementToBeClickable(likeButtonOnWeeklyFocus));
					    return likeButtonOnWeeklyFocus.getText();
					}
					...
					// This is used to click the Like button at WeeklyFocus
					public WeeklyFocus clickLikeOnWeeklyFocus() throws InterruptedException {
							JavascriptExecutor jk = (JavascriptExecutor) driver;
							jk.executeScript("window.scrollBy(0,400)", "");
							// Use WebDriverWait for waiting until the element is clickable
							 try {
								 likeButtonOnWeeklyFocus.click();
					...
					// Check Like count of the document before user login and refresh the same page and again click the Like button in WeeklyFocus
								public boolean displayLikeCountOfTheDocumentAfterRefreshInWeeklyFocus() throws InterruptedException {
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,500)", "");
								...
								public String getBeforeDownloadCount() {
									 // Use WebDriverWait for waiting until the element is clickable
							        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
									wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnWeeklyFocus));
								    return downloadButtonOnWeeklyFocus.getText();
								}
								...
								// This is used to click the Like button at WeeklyFocus
								public WeeklyFocus clickDownloadWeeklyFocus() throws InterruptedException {
								        ...
								        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
										wait.until(ExpectedConditions.elementToBeClickable(downloadButtonOnWeeklyFocus));
										downloadButtonOnWeeklyFocus.click();
										return this;
								}		
								
								// This is used to count the document Download before user login and refresh the same page and again click the Like button in WeeklyFocus
								public boolean displayDownloadCountOfTheDocumentAfterRefreshInWeeklyFocus() throws InterruptedException {
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,500)", "");
								...
								public WeeklyFocus clickShareWeeklyFocus() throws InterruptedException {
									synchronized (driver) {driver.wait(2000);}
									JavascriptExecutor jk = (JavascriptExecutor) driver;
									jk.executeScript("window.scrollBy(0,400)", "");
							...
							public WeeklyFocus copyThePageLink() throws InterruptedException {
								 // Use WebDriverWait for waiting until the element is clickable
							       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
							...
							// This is used to click on Whatsapp in Share  with window
							public WeeklyFocus clickWhatsapp() throws InterruptedException {
								 // Use WebDriverWait for waiting until the element is clickable
							       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public WeeklyFocus clickFacebook() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public WeeklyFocus clickGmail() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						// This is used to click on gmail in Share  with window
						public WeeklyFocus clickTelegram() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public WeeklyFocus clickCloseButtonInSharePopup() throws InterruptedException {
							 // Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public WeeklyFocus clickRandomPage() throws InterruptedException {
							JavascriptExecutor jk = (JavascriptExecutor) driver;
							jk.executeScript("window.scrollBy(0,400)", "");
						...
						public WeeklyFocus clickClearFilter() throws InterruptedException {
							// Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
						...
						public WeeklyFocus clickFilter() throws InterruptedException {
							// Use WebDriverWait for waiting until the element is clickable
						       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public WeeklyFocus clickSelectYear() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public WeeklyFocus clickApplyFilter() throws InterruptedException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
								...
								public WeeklyFocus clickMediumFilter() throws InterruptedException, AWTException {
									// Use WebDriverWait for waiting until the element is clickable
								       WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
