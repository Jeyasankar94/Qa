...
public class NewsTodayHindi extends VisionBaseClass {

	WebDriver driver;

	public NewsTodayHindi(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath = "//p[text()='News Today Hindi']")
	private WebElement NewsTodayHindi;

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div/div/div/main")
	private WebElement newsTodayHindiBannerText;

	@FindBy(xpath = "//span[text()='News Today Hindi']")
	private WebElement backNewsTodayHindi;

	@FindBy(xpath = "//*[@class='Home_main__OVLM4']/div/div[2]/div[2]/div[2]/div/div/div")
	...
	// Download the document on News Today Hindi For Random option
	@FindBy(xpath = "//*[@class='Home_main__OVLM4 main']/div[1]/div[2]/div[2]/div[2]/div/div/div/div/div/div[2]/div/div[2]/div")
	...
	private WebElement likeButtonOnNewsTodayHindi;
	...
	public boolean isLikeButtonClickable() {
		try {
			return likeButtonOnNewsTodayHindi.isEnabled() && likeButtonOnNewsTodayHindi.isDisplayed();
	...
	// This is used to click the News Today Hindi in Current Affairs
	public NewsTodayHindi clickNewsTodayHindi() throws InterruptedException {
		// Wait for a maximum of 20 seconds for the banner text to be displayed
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(NewsTodayHindi));
		NewsTodayHindi.click();
		return this;
	}

	// Display the Banner Text of News Today Hindi Page
	public boolean displayBannerTextOfNewsTodayHindi() throws InterruptedException {
	//	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		// Wait for a maximum of 10 seconds for the banner text to be displayed
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOf(newsTodayHindiBannerText));

		String text = newsTodayHindiBannerText.getText();
		extentTest.info(text);

		return newsTodayHindiBannerText.isDisplayed();
	}

	// This is used to click the News Today Hindi back button
	public NewsTodayHindi clickbackNewsTodayHindi() throws InterruptedException {
		// Wait for a maximum of 20 seconds for the banner text to be displayed
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(backNewsTodayHindi));
		backNewsTodayHindi.click();
		return this;
	}

	// This is used to click the Download button at News Today Hindi
	public boolean clickDownloadRandomnlyOnNewsTodayHindi() throws InterruptedException {
	...
	// This is used to get the Title of Document at News Today Hindi
	public boolean getTitleOfDocumentInNewsTodayHindi() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,400)", "");
	...
	// This is used to get the year of the Document at News Today Hindi
	public boolean displayYearOnDocumentInNewsTodayHindi() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
	...
	// This is used to get the Medium of the Document at News Today Hindi
	public boolean displayMediumOnDocumentInNewsTodayHindi() throws InterruptedException {
		// Wait for a maximum of 10 seconds before interacting with the download button
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	// This is used to click the Like Button in News Today Hindi documents
	public boolean displayAndLikeTheDocumentInNewsTodayHindi() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,500)", "");
	...
	public String getBeforeLikeCount() {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(likeButtonOnNewsTodayHindi));
		return likeButtonOnNewsTodayHindi.getText();
	}
	...
	// and again click the Like button in NewsTodayHindi
	public boolean displayLikeCountOfTheDocumentAfterRefreshInNewsTodayHindi() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,500)", "");
	...
	// This is used to click any one of the month Randomly at News Today Hindi in
	// Current Affairs
	public NewsTodayHindi clickAnyOneOfTheMonthOnNewsTodayHindi() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,400)", "");
	...
	// This is used to click the Like button at News Today Hindi (Static method)
	public NewsTodayHindi clickLikeOnNewsTodayHindi() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,400)", "");
		// Use WebDriverWait for waiting until the element is clickable
		try {
			likeButtonOnNewsTodayHindi.click();
	...
	// same page and again click the Like button in News Today Hindi
	public boolean displayDownloadCountOfTheDocumentAfterRefreshInNewsTodayHindi() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,500)", "");
	...
	public NewsTodayHindi clickShare() throws InterruptedException {
	...
	public NewsTodayHindi clickFilter() throws InterruptedException {
	...
	public NewsTodayHindi clickSelectYear() throws InterruptedException {
	...
	public NewsTodayHindi clickApplyFilter() throws InterruptedException {
	...
	public NewsTodayHindi clickClearFilter() throws InterruptedException {
		// Wait for a maximum of 10 seconds before interacting with the popup Apply Btn
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public NewsTodayHindi clickWhatsapp() throws InterruptedException {
		// Wait for a maximum of 10 seconds before interacting with the popup Apply Btn
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public NewsTodayHindi clickFacebook() throws InterruptedException {
		// Wait for a maximum of 10 seconds before interacting with the popup Apply Btn
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public NewsTodayHindi clickGmail() throws InterruptedException {
		// Wait for a maximum of 10 seconds before interacting with the popup Apply Btn
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	// This is used to click on gmail in Share with window
	public NewsTodayHindi clickTelegram() throws InterruptedException {
		// Wait for a maximum of 10 seconds before interacting with the popup Apply Btn
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	// This is used to click the News Today Hindi back button
	public NewsTodayHindi clickCloseButtonInShareWithPopup() throws InterruptedException {
		// Wait for a maximum of 10 seconds before interacting with the popup Apply Btn
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public NewsTodayHindi clickRandomPage() throws InterruptedException {
		JavascriptExecutor jk = (JavascriptExecutor) driver;
		jk.executeScript("window.scrollBy(0,400)", "");
